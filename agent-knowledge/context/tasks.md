...
| 2.7 | Session restore: on app launch (post-auth), list sessions from SQLite **filtered by `user_id = currentUser.id`** ordered by `lastActiveAt`. If ≥1, show session switcher; if 0, show folder picker. | M | 2.2, 8.5 | in progress | TIN-21 · devin-ed8694e17871491684900a048deca231 · branch `devin/1777569150-urgent-tin-batch`. |
