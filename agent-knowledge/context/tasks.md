...
| 13 | Vertical workspace sidebar | [[13-workspace-sidebar]] | Depends on multi-workspace UX which MVP doesn't have. Package scaffold landed via TIN-149 (review) — not wired into `App.tsx`; dead code per D25. |
