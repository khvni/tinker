...
| 02 | Dojo skill marketplace (local + optional Git sync) | p1 | not started | [[02-dojo-skill-marketplace]] | Vault-backed skill storage; browser UI; install/publish actions |
