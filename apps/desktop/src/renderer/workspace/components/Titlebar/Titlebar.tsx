...
export type TitlebarProps = {
  ...
  onOpenMemory: () => void;
  /**
   * Optional — when provided, renders a Playbook icon in the titlebar actions
   * row. Omitting the prop hides the entry (keeps the Playbook surface opt-in
   * for post-MVP consumers per D25).
   */
  onOpenPlaybook?: () => void;
};
